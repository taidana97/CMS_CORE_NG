...
namespace LoggingService
{
	public static class CustomConsoleThemes
	{
		...
		{
			[ConsoleThemeStyle.Text] = "\u001b[31m",
			[ConsoleThemeStyle.SecondaryText] = "\u001b[31m",
			[ConsoleThemeStyle.TertiaryText] = "\u001b[31m",
			[ConsoleThemeStyle.Invalid] = "\u001b[31m",
			[ConsoleThemeStyle.Null] = "\u001b[31m",
			[ConsoleThemeStyle.Name] = "\u001b[31m",
			[ConsoleThemeStyle.String] = "\u001b[31m",
			[ConsoleThemeStyle.Number] = "\u001b[31m",
			[ConsoleThemeStyle.Boolean] = "\u001b[31m",
			[ConsoleThemeStyle.Scalar] = "\u001b[31m",
			[ConsoleThemeStyle.LevelVerbose] = "\u001b[31m",

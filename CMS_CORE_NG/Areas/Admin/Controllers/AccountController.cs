        ...
        public async Task<IActionResult> Login([FromBody] LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    // set the value to 60 - as dont want the admin cookie to stay in browser for longer
            ...
            ModelState.AddModelError("", "Invalid Username/Password was enterd");
            Log.Error("Invalid Username/Password was enterd");
